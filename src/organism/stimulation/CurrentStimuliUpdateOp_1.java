...
public class CurrentStimuliUpdateOp_1 extends Operation {
  ...
  */
  public boolean precondition(StimulationSubsystem subsystem, Stimulus s){
    return subsystem.getStimulusStatus().get(s) == Stimulation.StimulusStatus.BEGINNING;
  }
  ...
  public void apply(StimulationSubsystem subsystem, Stimulus s){
    ...
    subsystem.getStimulusStatus().put(s, Stimulation.StimulusStatus.STABLE);
  }
}
