...
public class AngerRegulator_2 implements Serializable{
  ...
  public AngerRegulator_2(EmotionSubsystem emoSubsys, StimulationSubsystem stimSubsys){
    this.emoSubsys = emoSubsys;
    this.stimSubsys = stimSubsys;
  }
  
  public boolean precondition(){
    if(emoSubsys.getAnger().getStatus() == Emotion.EmotionStatus.INACTIVE){
      return true;
    }
