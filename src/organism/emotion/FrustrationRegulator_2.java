...
public class FrustrationRegulator_2 implements Serializable{
  ...
  public FrustrationRegulator_2(EmotionSubsystem emoSubsys){
    this.emoSubsys = emoSubsys;
  }
  
  public boolean precondition(){
    if(emoSubsys.getFrustration().getStatus() == Emotion.EmotionStatus.INACTIVE){
      return true;
    }
